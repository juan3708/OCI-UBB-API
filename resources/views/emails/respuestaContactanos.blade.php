...
<body style="background-color: #f6fafc; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6fafc;">
        <tbody>
            <tr>
                <td>
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        width="316" alt="Image" title="Image"></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 21px; color: #2c3547; line-height: 1.5; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 75px;">
                                                                            <span style="font-size:50px;">Hola,
                                                                                {{$name}}</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <div class="spacer_block"
                                                        style="height:35px;line-height:25px;font-size:1px;">&#8202;
                                                    </div>
                                                    ...
                                                    <table class="text_block" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #555555; line-height: 1.2; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            <span style="font-size:30px;">Muchas gracias
                                                                                por contactarte</span></p>
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            <span style="font-size:30px;">con
                                                                                nosotros.</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        role="presentation" width="10%"
                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                                        <tr>
                                                                            <td class="divider_inner"
                                                                                style="font-size: 1px; line-height: 1px; border-top: 2px solid #7179F6;">
                                                                                <span>&#8202;</span></td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                    ...
                                                    <table class="text_block" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 21px; color: #555555; line-height: 1.5; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="color:#8d8d8d;">responderemos
                                                                                tu duda a la brevedad, este atento a su
                                                                                correo.</span></p>
                                                                        <p
