                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <img class="icon"
                                                                                src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/801272_785116/editor_images/77c028aa-6cca-4596-b11f-ad6cdf592cf7.png"
                                                                                alt height="64" width="95"
                                                                                align="center"
                            ...
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0452ee; color: #000000; background-image: url('https://d1oco4z2z1fhwp.cloudfront.net/templates/default/7071/heasder-bg.png'); background-repeat: no-repeat; background-size: cover; width: 680px;"
                                        width="680">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                            ...
                                                            <td
                                                                ...
                                                                <h3
                                                                    ...
                                                                    <span class="tinyMce-placeholder">Con fecha:
                                                                        {{ $fecha }},
                                                                        hemos modificado correctamente el
                                                                        correo asociado a tu usuario, tu nuevo correo
                                                                        es:</span>
                                                                </h3>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span class="tinyMce-placeholder"
                                                                                style="font-size:20px;">En caso de desconocer este cambio y/o correo, le recomendamos comunicarse con el administrador.</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <h3
                                                                    ...
                                                                    <span class="tinyMce-placeholder"><strong>Olimpiadas
                                                                            chilenas de Informática&nbsp;-
                                                                            UBB</strong></span>
                                                                </h3>
                                                            </td>
                                                        </tr>
